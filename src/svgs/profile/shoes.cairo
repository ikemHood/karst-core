    ...
    pub fn get_shoes(shoe_color: ShoeColors) -> ByteArray {
        let shoe_color_hex1 = _get_shoe_color_hex(shoe_color);
        let shoe_color_hex2 = if let ShoeColors::GOLD = shoe_color {
            lens_colors::LensColors::LIGHT_GOLD
        } else {
            lens_colors::LensColors::WHITE
        };
        ...
        format!(
            ...
            <style>
                .shColor1{{fill:{};}}
                .shColor2{{fill:{};}}
                .shStroke{{stroke:#000;stroke-linecap:round;stroke-miterlimit:10;}}
            </style>
    ...
    fn _get_shoe_color_hex(shoe_color: ShoeColors) -> &'static str {
        match shoe_color {
            ShoeColors::GREEN => LensColors::DARK_GREEN,
            ShoeColors::PURPLE => LensColors::DARK_PURPLE,
            ShoeColors::BLUE => LensColors::DARK_BLUE,
            ShoeColors::PINK => LensColors::DARK_PINK,
            ShoeColors::DARK => LensColors::DARK,
            ShoeColors::LIGHT => LensColors::LIGHT_GRAY,
