pub mod headwear_bear {
    ...
    pub fn get_bear(
        ...
        (
            ...
            get_headwear_color(bear_color),
        )
    }

    fn get_bear_style(bear_color: BearColors) -> ByteArray {
        let (light_color, base_color) = get_bear_color(bear_color);
        format!(
    ...
    fn get_bear_color(bear_color: BearColors) -> (ByteArray, ByteArray) {
        match bear_color {
            BearColors::GREEN => (LensColors::LIGHT_GREEN, LensColors::BASE_GREEN),
            BearColors::PURPLE => (LensColors::LIGHT_PURPLE, LensColors::BASE_PURPLE),
            BearColors::BLUE => (LensColors::LIGHT_BLUE, LensColors::BASE_BLUE),
            BearColors::PINK => (LensColors::LIGHT_PINK, LensColors::BASE_PINK),
            BearColors::GOLD => (LensColors::LIGHT_GOLD, LensColors::BASE_GOLD),
        }
    }

    fn get_headwear_color(bear_color: BearColors) -> HeadwearColors {
        match bear_color {
            BearColors::GREEN => HeadwearColors::GREEN,
            BearColors::PURPLE => HeadwearColors::PURPLE,
            BearColors::BLUE => HeadwearColors::BLUE,
            BearColors::PINK => HeadwearColors::PINK,
            BearColors::GOLD => HeadwearColors::GOLD,
        }
    }
}