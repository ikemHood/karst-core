pub mod headwear_glasses {
    ...
    pub fn get_glasses(
        ...
        (
            ...
            get_headwear_color(glasses_color),
        )
    }

    fn get_glasses_style(glasses_color: GlassesColors) -> ByteArray {
        format!(
            r#"<style>.glassesColor1 {{ fill: {} }}</style>svgPath"#,
            get_glasses_color(glasses_color)
        )
    }

    fn get_glasses_color(glasses_color: GlassesColors) -> ByteArray {
        match glasses_color {
            GlassesColors::GREEN => LensColors::LIGHT_GREEN,
            GlassesColors::PURPLE => LensColors::LIGHT_PURPLE,
            GlassesColors::BLUE => LensColors::LIGHT_BLUE,
            GlassesColors::PINK => LensColors::LIGHT_PINK,
            GlassesColors::GOLD => LensColors::LIGHT_GOLD,
        }
    }

    fn get_headwear_color(glasses_color: GlassesColors) -> HeadwearColors {
        match glasses_color {
            GlassesColors::GREEN => HeadwearColors::GREEN,
            GlassesColors::PURPLE => HeadwearColors::PURPLE,
            GlassesColors::BLUE => HeadwearColors::BLUE,
            GlassesColors::PINK => HeadwearColors::PINK,
            GlassesColors::GOLD => HeadwearColors::GOLD,
        }
    }
}