    ...
    pub fn get_plants(
        plants_color: PlantsColors,
    ) -> (ByteArray, HeadwearVariants, HeadwearColors) {
        (
            format!(
                r#"<svg xmlns="http://www.w3.org/2000/svg" width="210" height="335" fill="none">{}</svg>"#,
                get_plants_style(plants_color)
            ),
            HeadwearVariants::PLANTS,
            get_headwear_color(plants_color),
        )
    }

    fn get_plants_style(plants_color: PlantsColors) -> ByteArray {
        format!(
            r#"<style>.color1 {{ fill: {} }} .color2 {{ fill: #fff }} .hwline3 {{ stroke: black; stroke-linecap: round; stroke-linejoin: round; stroke-width: 3 }} .hwline4 {{ stroke: black; stroke-linecap: round; stroke-linejoin: round; stroke-width: 4 }}</style>{}"#,
            get_plants_color(plants_color),
    ...
    fn get_plants_color(plants_color: PlantsColors) -> ByteArray {
        match plants_color {
            PlantsColors::GREEN => LensColors::BASE_GREEN,
            PlantsColors::PINK => LensColors::BASE_PINK,
            PlantsColors::PURPLE => LensColors::BASE_PURPLE,
            PlantsColors::BLUE => LensColors::BASE_BLUE,
            PlantsColors::GOLD => LensColors::BASE_GOLD,
        }
    }

    fn get_headwear_color(plants_color: PlantsColors) -> HeadwearColors {
        match plants_color {
            PlantsColors::GREEN => HeadwearColors::GREEN,
            PlantsColors::PINK => HeadwearColors::PINK,
            PlantsColors::PURPLE => HeadwearColors::PURPLE,
            PlantsColors::BLUE => HeadwearColors::BLUE,
