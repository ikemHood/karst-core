pub mod headwear_bull {
    ...
    pub fn get_bull(
        bull_color: BullColors,
    ) -> (ByteArray, HeadwearVariants, HeadwearColors) {
        (
            format!(
                r#"<svg xmlns="http://www.w3.org/2000/svg" width="250" height="335" x="-18.6" fill="none">{style}{}{}"#,
                get_bull_style(bull_color),
            ...
            get_headwear_color(bull_color),
        )
    }

    fn get_bull_style(bull_color: BullColors) -> ByteArray {
        let (light_color, base_color) = get_bull_color(bull_color);
        format!(
    ...
    fn get_bull_color(bull_color: BullColors) -> (ByteArray, ByteArray) {
        match bull_color {
            BullColors::GREEN => (LensColors::LIGHT_GREEN, LensColors::BASE_GREEN),
            BullColors::PURPLE => (LensColors::LIGHT_PURPLE, LensColors::BASE_PURPLE),
            BullColors::BLUE => (LensColors::LIGHT_BLUE, LensColors::BASE_BLUE),
            BullColors::PINK => (LensColors::LIGHT_PINK, LensColors::BASE_PINK),
            BullColors::GOLD => (LensColors::LIGHT_GOLD, LensColors::BASE_GOLD),
        }
    }

    fn get_headwear_color(bull_color: BullColors) -> HeadwearColors {
        match bull_color {
            BullColors::GREEN => HeadwearColors::GREEN,
            BullColors::PURPLE => HeadwearColors::PURPLE,
            BullColors::BLUE => HeadwearColors::BLUE,
            BullColors::PINK => HeadwearColors::PINK,
            BullColors::GOLD => HeadwearColors::GOLD,
        }
    }
}