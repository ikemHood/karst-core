...
pub mod headwear_scout {
    ...
    pub fn get_scout(
        scout_color: ScoutColors,
    ) -> (ByteArray, HeadwearVariants, HeadwearColors) {
        (
            format!(
                r#"<svg xmlns="http://www.w3.org/2000/svg" width="250" height="335" x="-18.6" fill="none">{}</svg>"#,
                get_scout_style(scout_color),
            ...
            get_headwear_color(scout_color),
        )
    }

    fn get_scout_style(scout_color: ScoutColors) -> ByteArray {
        let (light_color, base_color) = get_scout_color(scout_color);
        format!(
    ...
    fn get_scout_color(scout_color: ScoutColors) -> (ByteArray, ByteArray) {
        match scout_color {
            ScoutColors::GREEN => (LensColors::LIGHT_GREEN, LensColors::BASE_GREEN),
            ScoutColors::PINK => (LensColors::LIGHT_PINK, LensColors::BASE_PINK),
            ScoutColors::PURPLE => (LensColors::LIGHT_PURPLE, LensColors::BASE_PURPLE),
            ScoutColors::BLUE => (LensColors::LIGHT_BLUE, LensColors::BASE_BLUE),
            ScoutColors::GOLD => (LensColors::LIGHT_GOLD, LensColors::BASE_GOLD),
        }
    }

    fn get_headwear_color(scout_color: ScoutColors) -> HeadwearColors {
        match scout_color {
            ScoutColors::GREEN => HeadwearColors::GREEN,
            ScoutColors::PINK => HeadwearColors::PINK,
            ScoutColors::PURPLE => HeadwearColors::PURPLE,
            ScoutColors::BLUE => HeadwearColors::BLUE,
