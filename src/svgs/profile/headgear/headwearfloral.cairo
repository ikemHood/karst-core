pub mod headwear_floral {
    ...
    pub fn get_floral(
        ...
        (
            ...
            get_headwear_color(floral_color),
        )
    }

    fn get_floral_style(floral_color: FloralColors) -> ByteArray {
        let (primary_color, secondary_color) = get_floral_color(floral_color);
        format!(
            r#"<style>.floralColor1 {{ fill: {} }}.floralColor2 {{ fill: {} }}</style>svgPath"#,
            primary_color, secondary_color
        )
    }

    fn get_floral_color(floral_color: FloralColors) -> (ByteArray, ByteArray) {
        match floral_color {
            FloralColors::GREEN => (LensColors::LIGHT_GREEN, LensColors::BASE_GREEN),
            FloralColors::PURPLE => (LensColors::LIGHT_PURPLE, LensColors::BASE_PURPLE),
            FloralColors::BLUE => (LensColors::LIGHT_BLUE, LensColors::BASE_BLUE),
            FloralColors::PINK => (LensColors::LIGHT_PINK, LensColors::BASE_PINK),
            FloralColors::GOLD => (LensColors::LIGHT_GOLD, LensColors::BASE_GOLD),
        }
    }

    fn get_headwear_color(floral_color: FloralColors) -> HeadwearColors {
        match floral_color {
            FloralColors::GREEN => HeadwearColors::GREEN,
            FloralColors::PURPLE => HeadwearColors::PURPLE,
            FloralColors::BLUE => HeadwearColors::BLUE,
            FloralColors::PINK => HeadwearColors::PINK,
            FloralColors::GOLD => HeadwearColors::GOLD,
        }
    }
}