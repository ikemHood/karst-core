...
pub mod headwear_icecream {
    ...
    pub fn get_icecream(
        icecream_color: IcecreamColors,
    ) -> (ByteArray, HeadwearVariants, HeadwearColors) {
        (
            format!(
                r#"<svg xmlns="http://www.w3.org/2000/svg" width="210" height="335" fill="none"><style>.iceColor {{fill:{}}}</style>svgPath</svg>"#,
                get_icecream_color(icecream_color),
            ...
            get_headwear_color(icecream_color),
        )
    }

    fn get_icecream_color(icecream_color: IcecreamColors) -> ByteArray {
        match icecream_color {
            IcecreamColors::GREEN => LensColors::BASE_GREEN,
            IcecreamColors::PINK => LensColors::BASE_PINK,
            IcecreamColors::PURPLE => LensColors::BASE_PURPLE,
            IcecreamColors::BLUE => LensColors::BASE_BLUE,
            IcecreamColors::GOLD => LensColors::BASE_GOLD,
        }
    }

    fn get_headwear_color(icecream_color: IcecreamColors) -> HeadwearColors {
        match icecream_color {
            IcecreamColors::GREEN => HeadwearColors::GREEN,
            IcecreamColors::PINK => HeadwearColors::PINK,
            IcecreamColors::PURPLE => HeadwearColors::PURPLE,
            IcecreamColors::BLUE => HeadwearColors::BLUE,
