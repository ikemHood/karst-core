pub mod headwear_beanie {
    ...
    pub fn get_beanie(
        ...
        (
            ...
            get_headwear_color(beanie_color),
        )
    }

    fn get_beanie_style(beanie_color: BeanieColors) -> ByteArray {
        format!(
            r#"<style>.beanieColor {{ fill: {} }}.hwline3 {{stroke: black; stroke-linecap: round; stroke-linejoin: round; stroke-width: 3}}.hwline4 {{stroke: black; stroke-linecap: round; stroke-linejoin: round; stroke-width: 4}}</style>"#,
            get_beanie_color(beanie_color)
        )
    }

    fn get_beanie_color(beanie_color: BeanieColors) -> ByteArray {
        match beanie_color {
            BeanieColors::GREEN => LensColors::LIGHT_GREEN,
            BeanieColors::PINK => LensColors::LIGHT_PINK,
            BeanieColors::BLUE => LensColors::LIGHT_BLUE,
            BeanieColors::PURPLE => LensColors::LIGHT_PURPLE,
            BeanieColors::GOLD => LensColors::LIGHT_GOLD,
        }
    }

    fn get_headwear_color(beanie_color: BeanieColors) -> HeadwearColors {
        match beanie_color {
            BeanieColors::GREEN => HeadwearColors::GREEN,
            BeanieColors::PINK => HeadwearColors::PINK,
            BeanieColors::BLUE => HeadwearColors::BLUE,
            BeanieColors::PURPLE => HeadwearColors::PURPLE,
            BeanieColors::GOLD => HeadwearColors::GOLD,
        }
    }
}