pub mod headwear_brains {
    ...
    pub fn get_brains(
        ...
        (
            ...
            get_headwear_color(brains_color),
        )
    }

    fn get_brains_style(brains_color: BrainsColors) -> ByteArray {
        format!(
            r#"<style>.headwearColorL {{ fill: {} }}.hwStr1 {{stroke: #000;stroke-linecap: round;stroke-linejoin: round;}}</style>"#,
            get_brains_color(brains_color)
        )
    }

    fn get_brains_color(brains_color: BrainsColors) -> ByteArray {
        match brains_color {
            BrainsColors::GREEN => LensColors::LIGHT_GREEN,
            BrainsColors::PURPLE => LensColors::LIGHT_PURPLE,
            BrainsColors::BLUE => LensColors::LIGHT_BLUE,
            BrainsColors::PINK => LensColors::LIGHT_PINK,
            BrainsColors::GOLD => LensColors::LIGHT_GOLD,
        }
    }

    fn get_headwear_color(brains_color: BrainsColors) -> HeadwearColors {
        match brains_color {
            BrainsColors::GREEN => HeadwearColors::GREEN,
            BrainsColors::PURPLE => HeadwearColors::PURPLE,
            BrainsColors::BLUE => HeadwearColors::BLUE,
            BrainsColors::PINK => HeadwearColors::PINK,
            BrainsColors::GOLD => HeadwearColors::GOLD,
        }
    }
}
