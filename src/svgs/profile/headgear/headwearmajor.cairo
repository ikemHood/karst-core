    ...
    pub fn get_major(
        ...
        (
            format!(
                r#"<svg xmlns="http://www.w3.org/2000/svg" width="250" height="335" x="-14" fill="none">{}</svg>"#,
                get_major_style(major_color),
            ...
            get_headwear_color(major_color),
        )
    }

    fn get_major_style(major_color: MajorColors) -> ByteArray {
        let color = get_major_color(major_color);
        format!(
            r#"<style>.headwearColorB {{ fill:{} }}.hwStr1 {{ stroke: #000; stroke-linecap: round; stroke-linejoin: round; }}</style>{}"#,
            color,
            "svgPath"
        )
    }

    fn get_major_color(major_color: MajorColors) -> ByteArray {
        match major_color {
            MajorColors::GREEN => LensColors::BASE_GREEN,
            MajorColors::PINK => LensColors::BASE_PINK,
            MajorColors::PURPLE => LensColors::BASE_PURPLE,
            MajorColors::BLUE => LensColors::BASE_BLUE,
            MajorColors::GOLD => LensColors::BASE_GOLD,
        }
    }

    fn get_headwear_color(major_color: MajorColors) -> HeadwearColors {
        match major_color {
            MajorColors::GREEN => HeadwearColors::GREEN,
            MajorColors::PINK => HeadwearColors::PINK,
            MajorColors::PURPLE => HeadwearColors::PURPLE,
            MajorColors::BLUE => HeadwearColors::BLUE,
