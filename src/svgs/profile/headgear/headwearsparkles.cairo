pub mod headwear_sparkles {
    ...
    fn get_sparkles_style(sparkles_color: SparklesColors) -> ByteArray {
        format!(
            r#"<style>.hwcolor{{fill:#fff; stroke:{}; stroke-width: 3; stroke-linecap: square; stroke-linejoin: round}}</style>"#,
    ...
    fn get_sparkles_color(sparkles_color: SparklesColors) -> ByteArray {
        match sparkles_color {
            SparklesColors::NONE => LensColors::BLACK,
