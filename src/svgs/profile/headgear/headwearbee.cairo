pub mod headwear_bee {
    ...
    pub fn get_bee(
        ...
        (
            ...
            get_headwear_color(bee_color),
        )
    }

    fn get_bee_style(bee_color: BeeColors) -> ByteArray {
        let (light_color, base_color) = get_bee_color(bee_color);
        format!(
    ...
    fn get_bee_color(bee_color: BeeColors) -> (ByteArray, ByteArray) {
        match bee_color {
            BeeColors::GREEN => (LensColors::LIGHT_GREEN, LensColors::BASE_GREEN),
            BeeColors::PURPLE => (LensColors::LIGHT_PURPLE, LensColors::BASE_PURPLE),
            BeeColors::BLUE => (LensColors::LIGHT_BLUE, LensColors::BASE_BLUE),
            BeeColors::PINK => (LensColors::LIGHT_PINK, LensColors::BASE_PINK),
            BeeColors::GOLD => (LensColors::LIGHT_GOLD, LensColors::BASE_GOLD),
        }
    }

    fn get_headwear_color(bee_color: BeeColors) -> HeadwearColors {
        match bee_color {
            BeeColors::GREEN => HeadwearColors::GREEN,
            BeeColors::PURPLE => HeadwearColors::PURPLE,
            BeeColors::BLUE => HeadwearColors::BLUE,
            BeeColors::PINK => HeadwearColors::PINK,
